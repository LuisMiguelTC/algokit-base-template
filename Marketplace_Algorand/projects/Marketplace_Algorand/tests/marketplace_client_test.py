...
def test_delist_asset(
    ...
    print(f"\nL'asset è stato rimosso correttamente tramite close-to.")
    print(f"L'account del contratto non è più 'opted-in' all'asset.")
    print(f"Errore catturato: {excinfo.value}")
...
def test_deposit_non_owner_fails(
    ...
    print(f"\nDeposito non autorizzato respinto correttamente.")
    print(f"Il depositante non coincide con il proprietario registrato nella Box.")
    print(f"Errore catturato: {excinfo.value}")
...
def test_buy_asset_insufficient_balance_fails(
    ...
    print(f"\nAcquisto negato correttamente: saldo insufficiente rilevato dal contratto.")
    print(f"Errore catturato: {excinfo.value}")
...
def test_concurrency_race_condition(
    ...
    print(f"\nAcquisto Buyer 2 correttamente respinto.")
    print(f"Errore catturato: {excinfo.value}")
...
def test_delete_application(
    ...
    print(f"\nConfermata eliminazione del marketplace.")
    print(f"Errore catturato: {excinfo.value}")